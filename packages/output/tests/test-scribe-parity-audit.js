...
const tests = [
  ...
  },
  {
    ...
    fn: () => {
      assert.strictEqual(
        A.normalizePath('C:/Users/testuser/Workspace/cleanup.md'),
        A.normalizePath('C:\\Users\\testuser\\Workspace\\cleanup.md')
      );
    },
  },
  {
    ...
    fn: () => {
      ...
      assert.strictEqual(A.isTempPath('C:/Users/testuser/Workspace/cleanup.md'), false);
    },
  },
  {
