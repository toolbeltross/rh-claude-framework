...
const tests = [
  ...
  },
  {
    ...
    fn: () => {
      const patterns = ['personal-', 'financial-', 'personal-financial-samplematter'];
      assert.ok(slugBlocked('C--Users-x-Workspace-Personal-Divorce', patterns));
      assert.ok(slugBlocked('C--Users-x-Workspace-Personal-Financial-SampleMatter', patterns));
      assert.ok(!slugBlocked('C--Users-x-Workspace', patterns));
      assert.ok(!slugBlocked('C--Users-x-Workspace-toolbeltross-rh-platform', patterns));
    },
  },
  {
