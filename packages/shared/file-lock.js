...
//
// Cross-process safe: uses fs.writeFileSync(lockPath, pid, {flag: 'wx'}) for
// atomic O_EXCL create. PID-stamped, with 5s stale-lock recovery.
//
// Extracted 2026-05-02 from rh-scribe-prefilter.js appendRowsToFile (Phase 1
// C1 of PLAN-oversight-improvements-2026-05-02.md). Verified to 32-way
// parallel under stress test prior to extraction. Moved to packages/shared/
// in the 5-package reorg.
//
...
//
// USAGE:
//   const { withLock } = require('./lib/file-lock');  // post-install
